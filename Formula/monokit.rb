class Monokit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/stolmine/monokit/releases/download/v0.4.0/monokit-0.4.0-aarch64-apple-darwin.tar.gz"
      sha256 "dd00da48b59ef543d741b0479ebaa80fb22d83721815a1b87438ac0bca47aa00"
    end
  end
