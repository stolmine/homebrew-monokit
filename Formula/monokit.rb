class Monokit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/stolmine/monokit/releases/download/v0.5.31/monokit-0.5.31-aarch64-apple-darwin.tar.gz"
      sha256 "043afe43179ff4fc7495af6038f5952221775a6ea2b904a754eaf9362310a614"
    end
  end
