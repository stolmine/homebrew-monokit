class Monokit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/stolmine/monokit/releases/download/v0.3.4/monokit-0.3.4-aarch64-apple-darwin.tar.gz"
      sha256 "ab7480043404ae7fb2d9551e3febb631d5b702bca9c78e46003c8f16bbea35d9"
    end
  end
