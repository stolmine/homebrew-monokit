class Monokit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/stolmine/monokit/releases/download/v0.5.2/monokit-0.5.2-aarch64-apple-darwin.tar.gz"
      sha256 "bfc9cb0d1c823d9685707649a53b890f9d16722890836d653f63186e7bcfc381"
    end
  end
