class Monokit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/stolmine/monokit/releases/download/v0.6.1/monokit-0.6.1-aarch64-apple-darwin.tar.gz"
      sha256 "aa0907c5b98aaf7e799085a18add886873d44d9a7b260d4971d35e793b57496a"
    end
  end
